...
<template>
  <section aria-labelledby="statistics-ranking-title" class="space-y-3">
    ...
    <ol v-else class="space-y-2">
      <li
        ...
        :key="row.id"
        class="organic-card flex items-center gap-3 p-4"
      >
        ...
        <span class="text-sm text-base-content/70">{{ totalLabel(row.attendance_count) }}</span>
      </li>
    </ol>
  </section>
</template>
