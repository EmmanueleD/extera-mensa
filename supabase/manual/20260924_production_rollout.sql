-- Production rollout for username auth and the carpool scene.
--
-- Before running this file, disable email confirmation in the Supabase dashboard:
...
-- Verification: this query must return true.
select
  pg_get_functiondef('public.get_today_state()'::regprocedure) like '%d.created_at as declared_at%'
